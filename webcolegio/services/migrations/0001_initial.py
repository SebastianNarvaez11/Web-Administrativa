    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mensualidad', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)], verbose_name='Mensualidad')),
                ('matricula', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)], verbose_name='Matricula')),
